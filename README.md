...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(ventana, state="disabled", width=40, height=3, background="SkyBlue3", foreground="white", font=("Helvetica",15))
...
<a href="https://github.com/ArturoEmmanuelToledoAguado/GrafPython2/blob/main/calSimple.py">Código</a>